...
extension TextThemeExtension on TextTheme {
  ...
  TextStyle get overline1Semi => labelSmall!.copyWith(
        color: appColors.neutral1Color,
        fontWeight: FontWeight.w600,
        fontSize: 10.sp,
      );
  TextStyle get overline1Medium => labelSmall!.copyWith(
        color: appColors.neutral1Color,
        fontWeight: FontWeight.w500,
        fontSize: 10.sp,
      );
  TextStyle get overline1Regular => bodyLarge!.copyWith(
        color: appColors.neutral1Color,
        fontWeight: FontWeight.w400,
        fontSize: 10.sp,
      );

  TextStyle get overline2Bold => labelSmall!.copyWith(
        color: appColors.neutral1Color,
        fontWeight: FontWeight.w700,
        fontSize: 8.sp,
      );
  TextStyle get overline2Semi => labelSmall!.copyWith(
        color: appColors.neutral1Color,
        fontWeight: FontWeight.w600,
        fontSize: 8.sp,
      );
  TextStyle get overline2Medium => labelSmall!.copyWith(
        color: appColors.neutral1Color,
        fontWeight: FontWeight.w500,
        fontSize: 8.sp,
      );
  TextStyle get overline2Regular => bodyLarge!.copyWith(
        color: appColors.neutral1Color,
        fontWeight: FontWeight.w400,
        fontSize: 8.sp,
      );
